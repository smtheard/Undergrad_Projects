...
Node* ListContainer::union_func_iterative(Node* list1, Node* list2) //assumes both lists are sorted, and merges them
{
	...
	return newHead; // time_actual is blank + 17
}
